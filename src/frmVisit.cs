...
namespace Carga
{
    public partial class frmVisit : Form
    {
        ...
        private void tbl_visitBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            try
            {
                this.Validate();
                this.tbl_visitBindingSource.EndEdit();
        ...
        {
            // TODO: This line of code loads data into the 'pORTARIADataSet.tbl_visit' table. You can move, or remove it, as needed.
